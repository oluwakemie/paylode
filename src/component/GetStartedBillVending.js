...
const GetStartedBillVending = () => {
  return (
    ...
    <div className=" w-full md:w-[70%]">
      ...
      <p className="text-[24px] md:text-[32px] lg:text-[48px] text-[#124072] font-bold leading-tight">Initiate the process of seamless bill payment as swiftly as feasible.</p>
    </div>
    <div className="">
...
export default GetStartedBillVending