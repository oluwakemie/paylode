    ...
    <div class>
      ...
      <section className="px-[16px] flex flex-col justify-center gap-10  mt-10 md:flex-row md:px-[30px] lg:px-[90px] ">
        <div className="w-full md:w-[50%] ">
          ...
          <p className="text-[18px] ">
            ...
            worrying about bills and more time enjoying life.
          </p>
          <p className="text-[18px] mt-2">
            Whether you're developing for web, mobile, or desktop, Paylode bill vending API
            seamlessly integrates across platforms, providing a consistent and
      ...
      <section className="px-[16px]  gap-10  mt-10  md:px-[30px] lg:px-[90px]">
        <h1 className="text-[20px] md:text-[30px] lg:text-[40px] mb-4 font-semibold">
          {" "}
          Paylode helps your{" "}
          <span className="text-[#3BB75E]"> baseusiness grow</span>
        </h1>
